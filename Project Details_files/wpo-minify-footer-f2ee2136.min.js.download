...
jQuery(document).ready(function(){var $project_carousel=$(".owl-project-details");if($project_carousel.length){const item=$(window.location.hash);const startPosition=item.length?item.attr('data-index'):0;$project_carousel.owlCarousel({loop:!0,margin:0,items:1,smartSpeed:800,dotsEach:$('[class="owl-item"]').length+1,responsiveRefreshRate:!0,mouseDrag:!1,mouseDrag:!0,startPosition,navText:["<span class='prev-btn'><svg width='21' height='43' viewBox='0 0 21 43' fill='none' xmlns='http://www.w3.org/2000/svg'><path d='M18.8735 42L2 21.5189L18.8735 1.03778' stroke='#F89728' stroke-width='3'></path></svg></span>","<svg width='21' height='43' viewBox='0 0 21 43' fill='none' xmlns='http://www.w3.org/2000/svg'><path d='M1.99999 0.999999L18.8735 21.4811L1.99999 41.9622' stroke='#F89728' stroke-width='3'></path></svg></span>"],responsive:{0:{nav:!0,dots:!0,items:1,},1024:{nav:!0,dots:!1,items:1,},}});$project_carousel.on('drag.owl.carousel',function(event){var element=document.getElementById('gesuredZone');element.classList.add('blackline');element.classList.remove('border-white-left')});$project_carousel.on('dragged.owl.carousel',function(event){setTimeout(function(){var element=document.getElementById('gesuredZone');element.classList.remove('blackline');element.classList.add('border-white-left')},300)});$project_carousel.on('translate.owl.carousel',function(event){var element=document.getElementById('gesuredZone');element.classList.add('blackline');element.classList.remove('border-white-left');setTimeout(function(){element.classList.remove('blackline');element.classList.add('border-white-left')},300)})}
$('.header--momenu li.menu-item-has-children').each(function(){$(this).append('<a class="open-children" href="#"><svg aria-hidden="true" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" class="svg-inline--fa"><path fill="currentColor" d="M441.9 167.3l-19.8-19.8c-4.7-4.7-12.3-4.7-17 0L224 328.2 42.9 147.5c-4.7-4.7-12.3-4.7-17 0L6.1 167.3c-4.7 4.7-4.7 12.3 0 17l209.4 209.4c4.7 4.7 12.3 4.7 17 0l209.4-209.4c4.7-4.7 4.7-12.3 0-17z" class=""></path></svg></a>')});$('.open-children').click(function(e){e.preventDefault();e.stopPropagation();e.stopImmediatePropagation();const link=$(this).parent();const status=link.hasClass('active');if(status){link.find('.sub-menu').slideUp();link.removeClass('active')}else{link.find('.sub-menu').slideDown();link.addClass('active')}});function fix_header(){if($(window).scrollTop()>=150){$('.siteheader').addClass('fixed');$("#sitebody").addClass('header-pos-rel')}else{$('.siteheader').removeClass('fixed');$("#sitebody").removeClass('header-pos-rel')}}
fix_header();$(window).scroll(function(){fix_header()});var $carousel=$(".owl-hero");if($carousel.length){$carousel.owlCarousel({loop:!0,margin:0,nav:!1,dots:!0,autoplay:!0,lazyLoad:!0,autoplayTimeout:3500,autoplayHoverPause:!1,items:1,smartSpeed:800,responsiveRefreshRate:!0,mouseDrag:!0});$(window).load(function(){setTimeout(()=>{var carouselData=$carousel.data();var carouselOptions=carouselData['owl.carousel'].options;carouselOptions.autoplayTimeout=6000;$carousel.trigger('refresh.owl.carousel');$('.sc-home-hero').css('opacity','1');$('.loader').removeClass('active')},1500)})}});
